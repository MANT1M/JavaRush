...
содержит ли переданный параметр allModifiers
...
public class Solution {
    ...
    public static boolean isModifierSet(int allModifiers, int specificModifier) {
        ...
        //return ((Modifier.isPublic(allModifiers)==Modifier.isPublic(specificModifier))||(Modifier.isStatic(allModifiers)==(Modifier.isStatic(specificModifier))));
    }
